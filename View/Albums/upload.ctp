					...
					<div class="col-md-12">
						...
						<div class="panel panel-success options">
							...
							<div class="panel-footer options">
								...
								<a href="javascript:void(0)" class="btn btn-default btn-sm pull-left close-config" style="margin-left: 10px">Close</a>


								<button type="button" class="btn btn-warning btn-sm pull-right popovertrigger" style="margin-left: 10px"
